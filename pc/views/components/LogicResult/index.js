        ...
        return (
            <div className={styles.content}>
                ...
                <div className={styles.controller}>
                    <button type='button' className='btn' ref='run' onClick={this.runCode.bind(this)}><span className='glyphicon glyphicon-play'></span></button>
                    <button type='button' className='btn' ref='step' onClick={this.stepCode.bind(this)}><span className='glyphicon glyphicon-step-forward'></span></button>
                    <button type='button' className='btn' ref='forward' onClick={this.forwardCode.bind(this)}><span className='glyphicon glyphicon-forward'></span></button>
                </div>
            </div>
        )
    }
